...
impl RateLimiter {
    ...
    pub fn check_rate_limit(&self, key: &str, operation: &str) -> Result<()> {
        ...
        if inner.cleanup_last_run.elapsed() > Duration::from_secs(300) { // 5 minutes
        ...
        let recent_operations = operations.iter()
...
impl RateLimitStatus {
    pub fn remaining_minute(&self) -> usize {
        self.max_per_minute.saturating_sub(self.operations_this_minute)
    }
